<template>
  <div class="auth-container">
    ...
    <aside class="brand-panel">
      ...
      <div class="brand-orb brand-orb--1" aria-hidden="true" />
      <div class="brand-orb brand-orb--2" aria-hidden="true" />
      ...
      <div class="brand-content">
        ...
        <div class="brand-quote">
          <blockquote>
            "加入 SmartRecruit 是我职业生涯中最好的决定之一。
            这里汇聚了一群最聪明的人，一起用技术改变招聘行业。"
          </blockquote>
          <div class="brand-quote-author">
            <span>— 张明远，AI 算法专家</span>
          </div>
        </div>
      </div>
      ...
      <div class="mobile-header">
        <div class="mobile-logo">
          <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12 28V12l8 12L28 12v16" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          </svg>
        </div>
        <span class="mobile-brand">SmartRecruit</span>
      </div>

      <div class="form-wrapper">
        <div class="form-header">
          <h2 class="form-title">欢迎回来</h2>
          <p class="form-subtitle">使用手机号登录，首次登录将自动注册</p>
        </div>
        ...
        <div class="form-footer">
          <router-link to="/" class="footer-link">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" class="arrow-icon-left">
...
.brand-orb--2 {
  width: 260px;
  height: 260px;
  background: radial-gradient(circle, rgba(22, 119, 255, 0.6) 0%, transparent 70%);
  bottom: 10%;
  right: -12%;
}
...
.footer-link:hover .arrow-icon-left {
